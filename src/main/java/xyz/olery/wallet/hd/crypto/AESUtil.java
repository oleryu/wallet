...
import xyz.olery.wallet.hd.crypto.CharSequenceX;
...
//      String ret = Base64.encodeBase64String(ivAppended);
    ...
    public static void main(String[] args) {
        ...
        try {
            String keystore
                    = AESUtil.encrypt("0x4101faeb644250d955a1fc1fc8f4188b32636224c60d9bbd15e6d2e4f78ea2bf",
                    new CharSequenceX(passphrase), AESUtil.DefaultPBKDF2Iterations);
            System.out.println(keystore);

            try {
                String key = AESUtil.decrypt("b4v3GrWjvJ1vddDssPHXLbLx598tuKVeoP+M6YsotxhCZXZrvvXTdEGbSNdPFoknremKTDilOiWaZECYN1c69vRZFuPEessWlMX6bVw830y1CeXULkXQswzWTL4tcxvy",new CharSequenceX(passphrase),AESUtil.DefaultPBKDF2Iterations);
