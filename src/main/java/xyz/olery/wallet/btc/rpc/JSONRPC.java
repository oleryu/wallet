...
public class JSONRPC {
    ...
    public JSONObject getSth() {
        //getblockcount
        //getblockchaininfo
        //getnetworkinfo
        JSONObject json = doRPC(UUID.randomUUID().toString(), "getwalletinfo", null);
        if(json == null)    {
            return null;
        }
        try {
    ...
    public JSONObject pushTx(String hexTx) {
        ...
        System.out.println("JSONRPC" + " "+"response:" + json.toString());
        return json;
    }
    ...
    private JSONObject doRPC(String id, String method, JSONArray params) {
        ...
        try {
            ...
            System.out.println("JSONRPC" + json.toString());
            HttpPost httppost = new HttpPost("http://" + node + ":" + port);
            httppost.setEntity(myEntity);

            System.out.println("JSONRPC" + " " + "Request:" + httppost.getRequestLine());
            HttpResponse response = httpclient.execute(httppost);
            HttpEntity entity = response.getEntity();
            System.out.println("JSONRPC" +  response.getStatusLine().toString());
