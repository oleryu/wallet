...
public class MyTransactionOutPoint extends TransactionOutPoint {
    ...
    public MyTransactionOutPoint(NetworkParameters netParams, Sha256Hash txHash, int txOutputN, BigInteger value, byte[] scriptBytes, String address) throws ProtocolException {
        super(netParams, txOutputN, new Sha256Hash(txHash.getBytes()));
